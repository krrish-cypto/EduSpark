...
// Serve the EduSpark2.html file when someone visits the root URL
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'EduSpark2.html'));
});
...
// Tell Express to serve static assets (HTML, CSS, JS files)
// Assumes EduSpark2.html is in the same folder or parent folder
app.use(express.static(path.join(__dirname, '../'))); 

// Serve your main HTML file at the root URL
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '../EduSpark2.html'));
});
